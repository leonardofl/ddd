...
\item [Módulos], também chamados de pacotes (no java), são agrupamentos de classes. Devem possuir significado no domínio, ou seja, a hierarquia de móduos deve refletir uma hierarquia do domíno.
\end{description}
...
\item Repositório pede pro DAO perssitir o objeto.
\end{enumerate}
...
Detalhe importante: mesmo a interface que o DAO fornece não deve conter detalhes da tecnologia. Assim, tudo o que o domínio sabe é que a entidade está sendo salva em algum lugar, mas sem nenhuma dependência com alguma tecnologia específica.
