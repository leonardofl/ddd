...
Este documento é um compilado de notas de leitura sobre o livro ``\ddd: Atacando as Complexidades no Coração do Software''~\cite{Evans2003DDD}. Os objetivos deste documento são:
